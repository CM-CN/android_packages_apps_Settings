...
public class SeekBarPreferenceA extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public SeekBarPreferenceA(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
    ...
    public SeekBarPreferenceA(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SeekBarPreferenceA(Context context) {
        this(context, null);
    }
