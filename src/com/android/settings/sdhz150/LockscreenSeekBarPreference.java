...
public class LockscreenSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public LockscreenSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.SeekBarPreference);

        mMax = attrs.getAttributeIntValue(SETTINGS, "max", 10);
    ...
    public LockscreenSeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LockscreenSeekBarPreference(Context context) {
        this(context, null);
    }
